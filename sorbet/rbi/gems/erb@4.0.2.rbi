...
#
# source://erb//lib/erb/compiler.rb#72
class ERB::Compiler
  ...
  #
  # source://erb//lib/erb/compiler.rb#426
  def initialize(trim_mode); end

  # source://erb//lib/erb/compiler.rb#308
  def add_insert_cmd(out, content); end

  # source://erb//lib/erb/compiler.rb#304
  ...
  # @raise [ArgumentError]
  #
  # source://erb//lib/erb/compiler.rb#314
  def compile(s); end

  # source://erb//lib/erb/compiler.rb#374
  def compile_content(stag, out); end

  # source://erb//lib/erb/compiler.rb#361
  def compile_etag(etag, out, scanner); end

  # source://erb//lib/erb/compiler.rb#337
  def compile_stag(stag, out, scanner); end

  # The command to handle text that is inserted prior to a newline
  #
  # source://erb//lib/erb/compiler.rb#439
  def insert_cmd; end
  ...
  # source://erb//lib/erb/compiler.rb#420
  ...
  #
  # source://erb//lib/erb/compiler.rb#445
  def post_cmd; end
  ...
  #
  # source://erb//lib/erb/compiler.rb#442
  def pre_cmd; end
  ...
  # source://erb//lib/erb/compiler.rb#391
  def prepare_trim_mode(mode); end

  # The command to handle text that ends with a newline
  #
  # source://erb//lib/erb/compiler.rb#436
  def put_cmd; end
  ...
  #
  # source://erb//lib/erb/compiler.rb#450
  def content; end
  ...
  # source://erb//lib/erb/compiler.rb#468
  def warn_invalid_trim_mode(mode, uplevel:); end
end

# source://erb//lib/erb/compiler.rb#271
class ERB::Compiler::Buffer
  ...
  # source://erb//lib/erb/compiler.rb#294
  def close; end

  # source://erb//lib/erb/compiler.rb#288
  def cr; end
  ...
  #
  # source://erb//lib/erb/compiler.rb#282
  def script; end
end

# source://erb//lib/erb/compiler.rb#247
...
class ERB::Compiler::PercentLine
  ...
  #
  # source://erb//lib/erb/compiler.rb#77
  def to_s; end
...
# source://erb//lib/erb/compiler.rb#81
...
class ERB::Compiler::TrimScanner < ::ERB::Compiler::Scanner
  ...
  # source://erb//lib/erb/compiler.rb#203
  def explicit_trim_line(line); end

  # @return [Boolean]
  #
  # source://erb//lib/erb/compiler.rb#222
  def is_erb_stag?(s); end

  # source://erb//lib/erb/compiler.rb#145
  def percent_line(line, &block); end

  # source://erb//lib/erb/compiler.rb#133
  def scan(&block); end

  # source://erb//lib/erb/compiler.rb#158
  def scan_line(line); end

  # source://erb//lib/erb/compiler.rb#167
  def trim_line1(line); end

  # source://erb//lib/erb/compiler.rb#181
...
#   <b>30</b>
#
# source://erb//lib/erb/def_method.rb#32
module ERB::DefMethod
  ...
  #
  # source://erb//lib/erb/def_method.rb#35
